...
class AddForwardPopup(tk.Frame):
    ...
    def __init__(self, parent, close_callback):
        ...
        tk.Label(self, text="Number of Shots Taken:").grid(row=7, column=1)
        self._num_shots_took = tk.Entry(self)
        self._num_shots_took.grid(row=7, column=2)
        tk.Label(self, text="Number of Shots Made:").grid(row=8, column=1)
        self._num_shots_made = tk.Entry(self)
        self._num_shots_made.grid(row=8, column=2)
    ...
    def _submit_cb(self):
        ...
        data['player_type'] = str("forward")
        data['num_shots_made'] = int(self._num_shots_made.get())
        data['num_shots_took'] = int(self._num_shots_took.get())
